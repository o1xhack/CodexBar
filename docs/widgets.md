...
pluginkit -m -p com.apple.widgetkit-extension -i com.o1xhack.codexbar.widget -vv
```
Notes:
...
```
pluginkit -a "$WAPPEX"
pluginkit -e use -p com.apple.widgetkit-extension -i com.o1xhack.codexbar.widget
```
- Check for duplicates (old installs or version precedence):
```
pluginkit -m -D -p com.apple.widgetkit-extension -i com.o1xhack.codexbar.widget -vv
```
...
- Widget bundle id should be `com.o1xhack.codexbar.widget`.
