...
- [ ] Generate Sparkle appcast with private key
  ...
  - Generate the appcast + HTML release notes: `./Scripts/make_appcast.sh CodexBar-<ver>.zip https://raw.githubusercontent.com/o1xhack/CodexBar/mobile-dev/appcast.xml`
