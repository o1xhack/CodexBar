...
| 027 | Upstream Release Monitor Fix (release-based issues + external mention neutralization) | `done` | — | [027-upstream-release-monitor.md](027-upstream-release-monitor.md) | 2026-08-20 |
...
| 047 | v0.52.0 Upstream Sync + iOS 1.21.0 build 194 (issues #82-#88 plus authoritative v0.52.0; same iOS marketing version, provider display/sync and project-cost audit) | `done` | Signed/notarized Mac draft ready; CloudKit `NO_DEPLOY`; substituted 16-case matrix pass; push/merge/tag/live release/TestFlight/appcast publish intentionally unperformed | [047-v052-upstream-sync/00-overview.md](047-v052-upstream-sync/00-overview.md) | 2026-08-17 |
| 048 | v0.54.0 Upstream Sync + iOS 1.22.0 build 195 (issue #95 + Settings defect #97; v0.53.0-v0.54.0 as one train; cost provenance/coverage and provider sync audit) | `done` | Mac `0.54.0.1` public + signed appcast; iOS `1.22.0 (195)` TestFlight `VALID`; #95/#97 completed; CloudKit `NO_DEPLOY`; 16-case fleet matrix and macOS 27 Settings QA remain substituted | [048-v054-upstream-sync/00-overview.md](048-v054-upstream-sync/00-overview.md) | 2026-08-23 |
| 049 | v0.56.0 Upstream Sync + iOS 1.23.0 build 196 (issues #102-#104 plus authoritative v0.56.0; v0.54.1-v0.56.0 as one train; Claude slot migration, provider/cost compatibility and CLI hardening) | `done` | PR #105 merged; Mac `0.56.0.1` public + signed appcast; iOS `1.23.0 (196)` `VALID`, four-language metadata complete, and `WAITING_FOR_REVIEW` with `MANUAL` release; #102-#104 completed; CloudKit `NO_DEPLOY`; 16-case fleet matrix remains substituted | [049-v056-upstream-sync/00-overview.md](049-v056-upstream-sync/00-overview.md) | 2026-08-30 |
...
| 051 | v0.58.0 single upstream sync (10 releases; issues #108/#109/#111–118) | `in-progress` | Mac0.58.0.1已正式发布；iOS未上传，追加历史调查在独立052分支 | [051-v058-upstream-sync/00-overview.md](051-v058-upstream-sync/00-overview.md) | 2026-09-10 |
