...
struct OpenRouterPluginGoldenTests {
    ...
    @Test
    func `date specific activity deterministically replaces the latest completed history bucket`() async throws {
        let history = #"""
        {"data":[{"date":"2026-08-17","model":"openai/gpt-5.6","endpoint_id":"same",
